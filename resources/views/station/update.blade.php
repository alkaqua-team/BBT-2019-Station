...
<body>
    ...
    {{ csrf_field() }}
        <div class="container">
            ...
            <div class="input-box">目的地</br><input type="text" name="Station[destination]" id="destination" placeholder=""></div>
            <div class="input-box">想说的话</br><textarea name="Station[comment]" rows="7" cols="50" class="message"
                    id="message" placeholder=""></textarea></div>
        </div>
