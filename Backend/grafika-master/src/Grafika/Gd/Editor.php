...
final class Editor implements EditorInterface
{
     ...
     * @param string|null $type       Type of image. Can be null, "GIF", "PNG", or "JPEG".
     * @param string|null $quality    Quality of image. Applies to JPEG only. Accepts number 0 - 100 where 0 is lowest and 100 is the highest quality. Or null for default.
    ...
    public function text(&$image, $text, $size = 12, $x = 0, $y = 0, $color = null, $font = '', $angle = 0)
    {
        ...
        $color = ($color !== null) ? $color : new Color('#000000');
        $font = ($font !== '') ? $font : Grafika::fontsDir().DIRECTORY_SEPARATOR.'FZHTJW.ttf';
