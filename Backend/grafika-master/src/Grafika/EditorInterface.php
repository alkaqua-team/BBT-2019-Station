...
interface EditorInterface
{
     ...
     * @param string|null    $type       The image format to use. Can be null, "gif", "png", or "jpeg". If null, an appropriate format will be chosen based on the output file name in $file.
     * @param string|null    $quality    Quality of image. Applies to JPEG only. Accepts number 0 - 100 where 0 is lowest and 100 is the highest quality. Or null for default. Default quality if null is 75.
     ...
     * @throws \Exception
     */
    public function text(&$image, $text, $size = 12, $x = 0, $y = 12, $color = null, $font = 'FZHTJW.ttf', $angle = 0);
}
